...
Figure 3: RGB LED and low-pass filter wiring
...
Figure 4: A closer look at PWM output
...
Press A followed by the digits on the keypad to specify the frequency to use for the sine wave. The '*' button is the decimal point. Press '#' to accept the number.
